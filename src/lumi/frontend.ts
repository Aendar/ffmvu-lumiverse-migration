...
export function setup(ctx: SpindleFrontendContextLite) {
  ...
  const buttonBox = document.createElement('div'); buttonBox.style.display = 'flex'; buttonBox.style.gap = '8px'; buttonBox.append(button, probeButton);
