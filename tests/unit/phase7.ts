...
function main(): void {
  ...
  const playerOutfit = outfitDiff?.Outfit?.player as Record<string, unknown> | undefined;
  ...
  const injected = injectNarrativeHistoryContext(
    messages,
    { a1: { date: '1 июня, среда', time: '11:00' } },
    outfitDiff,
    stateTrail,
  );
